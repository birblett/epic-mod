...
public class CustomItems {
    ...
    public static final String ENFORCER_RIOT_SHIELD = withCustomModel("shield[enchantments={levels:{\"minecraft:mending\":1,\"minecraft:assault\":1,\"minecraft:unbreaking\":3}},custom_name='{\"color\":\"dark_red\",\"italic\":false,\"text\":\"Riot Shield\"}']", "riot_shield");
