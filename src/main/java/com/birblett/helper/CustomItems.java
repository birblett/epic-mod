...
public class CustomItems {
    ...
    public static final String DAEDALUS_STORMBOW = withCustomModel("bow[enchantments={levels:{\"minecraft:arrow_rain\":1,\"minecraft:flak\":1}}]", "stormbow");
    public static final String DAEDALUS_STORMBOW_DROPPED = withCustomModel("bow[custom_name='{\"color\":\"dark_red\",\"italic\":false,\"text\":\"Daedalus Stormbow\"}',enchantments={levels:{\"minecraft:arrow_rain\":1}},unbreakable={}]", "stormbow");
