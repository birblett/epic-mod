...
public class ArrowRain extends AnonymousTicker {
    ...
    public ArrowRain(LivingEntity entity, ServerWorld world, Vec3d target, ItemStack weaponStack, ItemStack projectileStack) {
        ...
        this.ticks = 12;
        this.ticksDelayed = projectileStack.getItem() instanceof FireworkRocketItem ? 3 : 2;
    }

    @Override
    public void tick() {
        if (this.ticks % this.ticksDelayed == 0 && this.weaponStack.getItem() instanceof RangedWeaponItem w) {
            ...
            AbilityUser a = (AbilityUser) projectileEntity;
            if (projectileEntity instanceof PersistentProjectileEntity p) {
               ...
               a.addAbilities(Ability.NOCLIP);
            }
            if (!(projectileEntity instanceof FireworkRocketEntity)) {
                a.addAbilities(Ability.IGNORE_IFRAMES);
            }
            ...
            a.addAbilities(Ability.NO_KNOCKBACK, Ability.DISCARD_AFTER);
